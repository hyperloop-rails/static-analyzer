...
def self.nonawards
where(is_award: false)
end

def self.for_commit_id
where(noteable_type: "Commit", commit_id: commit_id)
end
...
def self.legacy_diff_notes
where(type: 'LegacyDiffNote')
end

def self.non_diff_notes
where(type: ['Note', nil])
end
