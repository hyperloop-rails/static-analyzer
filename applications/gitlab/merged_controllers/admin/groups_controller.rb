...
ruby_code_from_view.ruby_code_from_view do |rb_from_view|
 ...
 css_class 
 link_to 'Edit', edit_admin_group_path(group), id: "edit_", class: 'btn btn-grouped btn-sm' 
 link_to 'Destroy', [:admin, group], data: {}, method: :delete, class: 'btn btn-grouped btn-sm btn-remove' 
 icon('bookmark') 
