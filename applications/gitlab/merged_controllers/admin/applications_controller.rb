...
ruby_code_from_view.ruby_code_from_view do |rb_from_view|
 ...
 link_to 'New Application', new_admin_application_path, class: 'btn btn-success' 
 @applications.each do |application| 
 link_to application.name, admin_application_path(application) 
 application.redirect_uri 
 application.access_tokens.map(&:resource_owner_id).uniq.count 
 link_to 'Edit', edit_admin_application_path(application), class: 'btn btn-link' 
