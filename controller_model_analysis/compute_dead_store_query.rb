def compute_dead_store_query
	...
	dead_store_pairs.each do |dsp|
		...
		$dead_store_file.puts "<filename>"
		$dead_store_file.puts "#{meth0.getCallerClass.getName}.#{meth0.getName}"
		$dead_store_file.puts "</filename>"
		$dead_store_file.puts "<loc>"
		$dead_store_file.puts "#{dsp[0].getLN}"	
		$dead_store_file.puts "</loc>"
		$dead_store_file.puts "<dead_store_query>"
		$dead_store_file.puts "<dead_store_query>"
		$dead_store_file.puts "<filename>"
		$dead_store_file.puts "#{meth1.getCallerClass.getName}.#{meth1.getName}"
		$dead_store_file.puts "</filename>"
		$dead_store_file.puts "<loc>"
		$dead_store_file.puts "#{dsp[1].getLN}"	
		$dead_store_file.puts "</loc>"
		$dead_store_file.puts "<dead_store_query>"
		$dead_store_file.puts "</dead_store_pairs>"
